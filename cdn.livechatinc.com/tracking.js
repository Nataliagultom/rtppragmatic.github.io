! function() {
    ...
    var en = function(n) {
        ...
        Cn = "always visible",
        In = "always hide",
        En = "hide until it gets activated";
        ...
        return function(r) {
            var i, o = (void 0 === r ? {} : r).prettyPrint,
                ...
                l = function(e) {
                    var n = "";
                    return {
                        desktopVisibility: n = e.initiallyHidden ? e.disabledMinimized ? In : En : Cn,
                        mobileVisibility: e.hasCustomMobileSettings ? e.hiddenOnMobile ? In : e.initiallyHiddenOnMobile ? e.disabledMinimizedOnMobile ? In : En : Cn : n
                    }
    ...
    function rt(e, t, r) {
        ...
        void 0 === (i = p.other) && (i = []), i.forEach((function(e) {
            ...
            function(e) {
                ...
                return a._v
            }, a.diagnose = Ln(e, t, r), fe(Fn(e, Wn), ce((function() {
                var e;
                e = function(e) {
    ...
    var it = function() {
        ...
        Lt = function(e, n) {
            ...
            return Et(e, n) ? t.screenPositionOnMobile : t.screenPosition
        },
        xt = function(e, n) {
            var t = e.__unsafeProperties.group;
            return Et(e, n) ? {
        ...
        jt = function(e, t, r) {
            ...
            if (i.enabled && ! function(e, n) {
                    var t = e.__unsafeProperties.group;
                    return Et(e, n) ? t.disabledMinimizedOnMobile : t.disabledMinimized
                }(t)) {
    ...
    var Gt = function(e) {
        ...
        function t(t) {
            n = !0,
                function(e) {
                    return !(e.metaKey || !Vt() && e.altKey || e.ctrlKey)
    ...
    var Jt = {
        ...
        Zt = function() {
            ...
            var i = function() {
                var e, r = k(t);
                return r ? (e = r, Qt() - e.startTime + e.duration) : Qt() - n
            };
            return {
                disconnect: function() {
                    return r.disconnect()
                    ...
                    getLogs: function() {
                        return e.then((function(e) {
                            ...
                            return c((function(e) {
                                ...
                                timeFromTrackingStart: tr(t, i),
                                timeFromBridgeInit: tr(r, i),
                                timeFromDomContentLoaded: rr(i),
    ...
    var ar, ur = "__test_storage_support__",
        cr = "@@test",
        sr = function(e) {
            void 0 === e && (e = "local");
            try {
                var n = "session" === e ? window.sessionStorage : window.localStorage;
                return n.setItem(ur, cr), n.getItem(ur) !== cr ? !1 : (n.removeItem(ur), !0)
            } catch (e) {
                return !1
            }
        },
        ...
        lr = (sr() && window, Object.freeze({
            success: !0
        }), (ar = {}).CONNECTION_LOST = "Connection lost.", ar.MISDIRECTED_CONNECTION = "Connected to wrong region.", function(e) {
            return e.map((function(e) {
                switch (e.type) {
                    case "group_chooser":
                        return n({}, e, {
        ...
        hr = function(e) {
            var n = e.__priv,
                t = {
                    ...
                    src: pr(n.group["embedded_chat.eye_grabber.path"])
                };
            if (-1 !== t.src.indexOf("/default/eyeCatchers/")) {
                var r = t.src.match(mr)[1];
                t.srcset = {
                    "1x": t.src,
        ...
        _r = function e(t) {
            return te(vr("get_dynamic_configuration", t), {
                query: n({
            ...
            return n({}, S(e, ["buttons", "allowed_domains", "prechat_form", "ticket_form", "__priv"]), i && {
                ...
                buttons: t.map((function(e) {
                    return "image" === e.type ? {
                        id: e.id,
                        type: e.type,
                        onlineValue: pr(e.online_value),
                        offlineValue: pr(e.offline_value)
                    } : {
                        id: e.id,
                        type: e.type,
                ...
                __unsafeProperties: n({}, a.s && {
                    ...
                    group: {
                        ...
                        eyeCatcher: "1" === a.group["embedded_chat.display_eye_catcher"] ? hr(e) : {
                            enabled: !1
                        },
    ...
    function Ir(e, n) {
        ...
        if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
            if (Array.isArray(e) || (t = function(e, n) {
                    ...
                    if ("Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)) return Er(e, n)
    ...
    var xr = Tt(),
        ...
        Tr = function(e, n, t) {
            var r, i, o, a = xt(n, xr);
            return !e && t ? ((i = {})[Lt(n, xr)] = "0", i.bottom = a.y + "px", i.maxHeight = "100%", i) : xr && e ? ((o = {})[Lt(n, xr)] = "0", o.bottom = "0", o.maxHeight = "100%", o) : ((r = {})[Lt(n, xr)] = a.x + "px", r.bottom = a.y + "px", r.maxHeight = "calc(100% - " + a.y + "px)", r)
        },
        Pr = function(e) {
        ...
        zr = function(e, t) {
            ...
            return j(n(((r = {
                width: u.width,
                height: u.height
            })[Lt(e, xr)] = o.x + "px", r), a), i), i
        },
        Sr = function(t, r, i, o, a, u) {
            var c, s, f = B(d(n({
                ...
                p = {
                    ...
                    resize: function(e) {
                        var r = void 0 === e ? {} : e,
                            ...
                            a = Tr(r.maximized, i, r.ignoreHorizontalOffset);
                        j(n({}, o, a), t.element);
                    ...
                    renderCrossFrameMarkup: function(e) {
                        ...
                        o || (o = document.createElement("iframe"), M(n({}, hn, {
                            ...
                            function(e, n, t, r) {
                                ...
                                for (var o, a = i.documentElement, u = Ir(P(a.querySelectorAll("[" + kr + "]"))); !(o = u()).done;) {
                                    var c = o.value,
                                        s = c.getAttribute(kr);
                                    if ("string" == typeof s)
                                        for (var d, l = function() {
                                                ...
                                                c.removeAttribute(kr), c.addEventListener(n, (function(e) {
                                            ...
                                            }, f = Ir(s.split(";")); !(d = f()).done;) l()
                                }
                                var p = a.querySelector("[" + br + "]");
                                p && (p.removeAttribute(br), p.focus(), "INPUT" === p.nodeName) && p.setSelectionRange(p.value.length, p.value.length);
                                for (var m, h = [], v = function() {
                                    ...
                                    }, g = Ir(P(a.querySelectorAll("[" + Cr + "]"))); !(m = g()).done;) v();
                                h.forEach((function(e) {
                                    return e(r.state)
                                })), r.off("state_diff", Lr), r.on("state_diff", Lr = function(e) {
                                    var n;
        ...
        jr = function(e, n, t, r, i) {
            e.call("storeMethod", ["setLocalization", r]), Gt(e), t.custom || St(t.element, (function() {
                    return Sn(e.state, "hidden")
                })), xr || "wix" === n.integrationName || jt(e, i, r), Pr(e.frame),
                function(e, n, t) {
                ...
                }(e), Nt(e, i), xr && Yt(e), Ht(e), e.on("rich_greeting_button_clicked", (function(e) {
                    var n = e.button;
        ...
        Mr = function(t) {
            return "openwidget" === t.product ? te("https://api.openwidget.com/v1.0/configuration/" + t.organizationId, {
                ...
                return _("livechat", o) ? n({}, c, gr(t), {
                    licenseId: a
                }) : c
            })) : _r(t).then((function(r) {
                var i;
                return e.all([r, (i = {
        ...
        Nr = function(t) {
            ...
            e.all([Mr(s), "wix" === u ? Wt() : qt(), q()]).then((function(i) {
                var a = i[0],
                    u = i[1],
                    l = i[2];
                if (yn(a.allowedDomains, window.top === window ? window.location.hostname : document.referrer)) {
                    if (!xr || !a.__unsafeProperties.group.disabledOnMobile || t.actingAsDirectLink) {
                        var f = ir(),
                            p = function(e) {
                            ...
                            h = function(e, n) {
                                return e.customContainer ? {
                                    ...
                                    custom: !1,
                                    element: zr(n, e.actingAsDirectLink),
                                    size: Ar(n)
                                }
                            }(t, a),
                            v = {},
                        ...
                        h.custom || l.appendChild(h.element), window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bind_child"), e.all([Sr(h, b, a, p, null, s.product), "openwidget" === s.product ? e.resolve(a.localization) : (y = {
                            licenseId: b.license,
                            groupId: b.group,
                            region: b.region,
                            version: a.localizationVersion,
                            language: a.__unsafeProperties.group.language
                        }, te(vr("get_localization", y), {
                            ...
                            var n = e[0],
                                t = e[1];
                            return h.custom || Pr(h.element), jr(n, b, h, t, a), fe(jn(n, (function(e) {
                                return We(e, "readyState")
                            })), ue((function(e) {
                                return e === Bn
                            })), Ee(1), me((function() {
                            ...
                            window.performance && "function" == typeof window.performance.mark && window.performance.mark("lc_bridge_ready"), f && f.getLogs().then((function(n) {
                                ...
                                (function(e) {
                                    return or(vr("get_localization", e) + "?" + B(n({
    ...
    function Dr() {
        q().then((function(e) {
            ...
            ["https://cdn.livechatinc.com/widget/static/js/runtime-configurator.6bdb6949.js", "https://cdn.livechatinc.com/widget/static/js/0.0f55d8dd.chunk.js", "https://cdn.livechatinc.com/widget/static/js/1.e70c3212.chunk.js", "https://cdn.livechatinc.com/widget/static/js/configurator.35760a86.chunk.js"].forEach((function(e) {
                ! function(e, n) {
    ...
    var qr = function(e) {
        ...
        Hr = function() {
            return e = "cw_configurator", n = window.location.search, X(n)[e] || sr("session") && !!window.sessionStorage.getItem("cw_configurator");
            var e, n
        };
    window.__lc_inited || function() {
        if (window.__lc_inited = !0, "msCrypto" in window) console.error("[LiveChat] We no longer support Internet Explorer");
            ...
            var e, t, r = (e = window.__lc, {
                ...
                requestedGroupId: qr(e),
                uniqueGroups: !1 === e.chat_between_groups,
                customer: Fr(e.visitor, e.params),
            ...
            r.actingAsDirectLink || !Hr() ? Nr(n({}, r, {
                product: "livechat"
            })) : Dr()
